...
public class ExcelService 
{
	...
	public ResponseEntity<String> saveExcel(MultipartFile file) 
			...
			try 
				{
					...
					for (int i = 1; i < worksheet.getPhysicalNumberOfRows(); i = i + 1) 
						{
							XSSFRow row = worksheet.getRow(i);
							
							ExcelFile dariq = this.getModelFromRow(row, 8,9,10, "Dari");
							ExcelFile pashtoq = this.getModelFromRow(row, 4,5,6, "Pashto");
							ExcelFile engq = this.getModelFromRow(row, 0, 1, 2, "English");
							englishQ.add(engq);
							pashtoQ.add(pashtoq);
							dariQ.add(dariq);
		...
		/* File 1 Logic ....File Store in src\main\resources\File\File.xlsx */
...
//	}
		...
		/* File 1 Logic ....File Store in src\main\resources\File\File1.xlsx */
